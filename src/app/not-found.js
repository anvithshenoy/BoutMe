...
const Error404 = () => {
  return (
    <>
      ...
      >
        <span className="absolute inset-0 -translate-x-full transform animate-shimmer bg-gradient-to-r from-transparent via-foreground to-transparent opacity-50 delay-500" />
